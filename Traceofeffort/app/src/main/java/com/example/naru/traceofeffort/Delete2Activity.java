        ...
        editText.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_DOWN
                    ...
                    if(count==0){
                        my_toast =  Toast.makeText(Delete2Activity.this, "アプリが見つかりませんでした", Toast.LENGTH_SHORT);
                        my_toast.show();
                    }
      ...
      //  final ListView listView = new ListView(this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                /*ApplicationInfo ai = installedAppList.get(position);*/
                String packname1 = dataList.get(position).pname;
                Uri uri = Uri.fromParts("package", packname1, null);
                Intent intent = new Intent(Intent.ACTION_DELETE, uri);
                startActivity(intent);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    // 音声認識が実行できない場合
                    my_toast = Toast.makeText(Delete2Activity.this,
                    ...
                    if (ck != -1) {
                       /* String start = dataList.get(i).pname;
                        ...
                        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                String packname3 = givelist.get(position).pname;
                                Uri uri = Uri.fromParts("package", packname3, null);
                                Intent intent = new Intent(Intent.ACTION_DELETE, uri);
                                startActivity(intent);
                            }
                        });
